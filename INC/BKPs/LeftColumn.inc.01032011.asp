			...
			<table style="width:210px; border:0px solid red;" cellpadding="5px" cellspacing="0" >   
				<tr>
					<td align="center" valign="bottom">
						...
						<p><br><font face="Tahoma">You are currently a 
                ...
                <tr>
                    ...
                    <form action="https://www.starlite-intl.com/scart/scart.asp?sid=197&amp;sar=&amp;area=GPS+Navigation%2C+GPS+Sensors%2C+OEM%2C+FishFinders%2C+Maps." method="Post" >
                        <center>
                            <input type="Submit" value="Check for GPS Rebates"></input>
                        </center>
                    </form>
                    ...
                    <tr >
                    <td >
                        <a href="https://www.starlite-intl.com/Detail.asp?pid=1509">
                        <img alt="GPS 18 5Hz" src="https://www.starlite-intl.com/Imi/gps18-5hzt.jpg" height="58" width="74">
                        </a>
                        <b>GPS 18 5Hz</b> by Garmin with <b>carrier Phase tracking</b>, 
                        highly accurate receiver. For OEM clients; for use in machine control, guidance, 
                        various agricultural <font color="#FF0000"> applications where 5 Hz position and velocity reports are
                        required</font>.
                    </td>
                    </tr>
