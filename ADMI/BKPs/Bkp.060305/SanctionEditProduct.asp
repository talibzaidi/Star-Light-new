...
<% 
' 2/22/06, BN: This file is almost identical to Sanctionproduct.asp. Don't know why both are needed, but they are.
...
<tr>
	...
	<FORM ACTION="sanctioneditproduct.asp?PID=<%=PIDD%>" METHOD=POST>
    <tr>
	...
	<tr>
	                    ...
	                    <input type="text" size="30" name="Descr" value="<%=RVS("Descr")%>">
			    </td><td ></td>
	</tr>
	...
	<tr>
	                    <td align=right><font size="2" face="Arial" color="#FFBD00">New Product:</font>
			    </td>
	...
	<tr>
	                    <td align=right><font size="2" face="Arial" color="#FFBD00">Over Sized:</font>
			    </td>
