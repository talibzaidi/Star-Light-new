...
If Action = "SUBMIT" Then
	...
	If msg = "" Then
		 ...
		 SQL = "INSERT INTO Links ( Name, CoLink ) "
                 SQL = SQL & " VALUES('" & NAME & "' ,'" & COLINK & "')"
...
'74 74 74 74 74 74 74 74 74 74 74 74 
	'Response.Redirect "sanctioneditlinks.asp?ID=" & ReQuest("ID") 'DEBUG CODE
...
Elseif  Action = "EDIT" Then
	...
	If msg = "" Then
	 ...
	 Response.Redirect "sanctioneditlinks.asp?ID=" & ReQuest("ID")
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
    ...
    <tr>
        ...
        <td><font color="#FFBD00" size="2" face="Arial">Edit links with the form below. Choose an existing link from the top to edit, or from the bottom to delete. New links are entered using the form. <br></td>
    </tr>
    <tr>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
    ...
    <tr>
		...
		<table border="0" cellpadding="3" cellspacing="0"  ALIGN="CENTER">
                <tr><FORM ACTION="sanctionlinks.asp" METHOD=POST>
...
%>
            ...
            </form><FORM ACTION="sanctionlinks.asp" METHOD=POST>
		<tr>
                    <td ><font size="2" face="Arial" color="#FFBD00">Link Name:</font>
		    </td>
                    <td width="100"><font size="2" face="Arial"></font><input type="text" size="30" name="Name" value="<%=Request("Name")%>">
...
<tr>
                    ...
                    <td width="100"><font size="2" face="Arial"></font><TEXTAREA COLS="12" ROWS="7" NAME="CoLink" STYLE="width: 403px;"><%=Request("CoLink")%></TEXTAREA>
		    </td><td ></td>
                </tr>

<tr><td colspan="3"> <br><br>
</td></tr>
         </form><FORM ACTION="sanctionlinks.asp" METHOD=POST>       <tr>
