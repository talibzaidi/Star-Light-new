...
<% 
' 2/22/06, BN: This file is almost identical to SanctionProductEdit.asp. 
' Don't know why both are needed, but they are.
...
ToDo = UCase(Request.QueryString("ToDo"))
...
<tr>
    ...
    No two Product ID's can be the same.</font>
    </td>
</tr>
...
<tr>
    ...
    <% If ToDo = "EDIT" Then %>
	<FORM ACTION="SanctionProductInsertNew.asp?ToDo=EDIT2" METHOD=POST>
	<tr>
		<td  bgcolor="#bbbbbb">
        <font size="2" face="Arial" color="#000000"><b>PRODUCT EDIT:<b></font>
	    </td>
	...
	<tr>
	    ...
	    <td width="100">
			...
			<tr>
				<td>
				<input type="text" size="30" name="Cost" value="0.0<%=Request("Cost")%>">
				</td>
				<td align='right'>
				<font size="2" face="Arial" color="#FFBD00">&nbsp;&nbsp;&nbsp;Vendors:</font>
				</td>
				<td>
				<input type="text" size="99" maxlength=250 name="Vendors" value="<%=Request("Vendors")%>">
				</td>
			</tr>
			</table>
		</td>
	...
	<tr>
        ...
        <td colspan="2"><input type="checkbox" size="30" name="Deleted" value="<%=True%>" >
    ...
    <% If ToDo = "DELETE" Then %>
	<FORM ACTION="SanctionProductInsertNew.asp?ToDo=DELETE2" METHOD=GET>       
	<tr>
	    ...
	    <td  bgcolor="#790000"><INPUT type="submit" VALUE="DELETE" ></td>
	</tr>
	</FORM>
    <% End If   ' ToDo = "DELETE" %>
