...
'     response.redirect "./error.asp"
'end if
		 Response.Redirect "sanctioneditproduct.asp?PID=" + PID
	End If  'msg = ""
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
    ...
    <tr>
		...
		<table border="0" cellpadding="3" cellspacing="0"  ALIGN="CENTER">
                <tr><FORM ACTION="sanctioneditproduct.asp?PID=<%=PID%>" METHOD=POST>
...
<tr>
                    ...
                    <td width="100"><font size="2" face="Arial"></font><input type="text" size="30" name="Descr" value="<%=RVS("Descr")%><%=Request("Descr")%>">
		    </td><td ></td>
                </tr>
<tr>
                    <td ><font size="2" face="Arial" color="#FFBD00">Text: (65535 characters max.)</font>
		    </td>
                    <td width="100"><font size="2" face="Arial"></font><textarea cols="25" name="Text1" rows="5" wrap="virtual"  value="<%=Request("Text1")%>"><%=RVS("Text1")%></textarea>
		    </td><td ></td>
                </tr>
<tr>
                    <td ><font size="2" face="Arial" color="#FFBD00">Bullets (65535 characters max. use the tilde <b>~</b> to add a bullet ):</font>
		    </td>
                    <td width="100"><font size="2" face="Arial"></font><textarea cols="25" rows="5" name="Text2" wrap="virtual" value="<%=Request("Text2")%>"><%=RVS("Text2")%></textarea>
		    </td><td ></td>
                </tr>
<tr>
...
<tr>
                    <td ><font size="2" face="Arial" color="#FFBD00">Weight:</font>
		    </td>
...
<tr><td colspan="3"> <br><br>
         ...
         </form><FORM ACTION="sanctioneditproduct.asp" METHOD=POST>       <tr>
