...
PID_SID	= Request.QueryString("PID_SID")		' Returned by FORM1.
...
Response.Write "<br>txtNextActionButton = " & txtNextActionButton
...
If Action = "SubmitProductChanges" Then	
	...
	Response.Redirect "SanctionProduct.asp?Action=DisplayProductToEdit" & "&PID=" & PID & "&SID=" & SID
...
ElseIf Action = "SubmitNewProduct" Then	
	...
	' 12/17/11: This cannot work yet, because do NOT know PID at this stage.
	' The following (hopefully) takes user back to the display of the product just edited, so he can check his changes.
	'Response.Redirect "SanctionProduct.asp?PID=" & PID & "&Action=Display+Product+to+Edit"
...
Elseif  Action = "DeleteThisProduct" Then
	...
	Response.Redirect "SanctionProduct.asp"		' This just takes you back to where you were, to continue working ?
	'End If  'msg = ""


'Elseif  Action = "EDIT" Then
	'Response.Redirect "SanctionProduct.asp?PID=" & Request("PID")
...
<tr>
	...
	No two Item IDs should be the same.
	</td>
</tr>
<% ElseIf Action = "DeleteOld" Then %>
<tr>
...
<tr>
	...
	<tr>
		...
		<!-- <FORM Name="FORM1" ACTION="http://www.starlite-intl.com/Admi/SanctionProduct.asp?Action=<%=submitButtonValue%>" METHOD="GET" > --> 
	...
	<% End If   '  Action = "EditOld" OR Action = "DeleteOld" %>
	...
	<% 
	If (Action = "CreateNew") OR (Action = "DisplayProductToEdit") OR (Action = "DisplayProductToDelete") Then 
	%>
