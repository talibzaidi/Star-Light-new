...
If Action = "SUBMIT" Then
  ...
  RS.Open  "Select ITEMID, GPM from Product WHERE SID=" & Request("SID") , "DSN=STAREC1" , 1, 4
	...
	loop
       ...
       Response.Redirect "Sanctionglobalgpm.asp"

	
elseIf Action = "CHANGE" Then
	 set RUS = CreateObject("ADODB.Recordset")
	 set RS = CreateObject("ADODB.Recordset")
  RS.Open  "Select ITEMID, GPM from Product WHERE SID=" & Request("SSID") , "DSN=STAREC1" , 1, 4
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
    ...
    <tr>
        ...
        <td><font color="#FFBD00" size="2" face="Arial">Set your global GPM change in decimal form. [ 0.5 = 50% ]</u> Choose by Sub-Area. </font></td>
    </tr>
    <tr>
        <td><font face="Arial"><img
...
<FORM ACTION="sanctionglobalgpm.asp" METHOD="POST">
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
    ...
    <tr>
		...
		<tr>
                    <td ><font size="2" face="Arial" color="#FFBD00">GPM Multiplier:</font>
		    </td>
...
%>
			...
			RS.Close %>
               ...
               <tr>
                    <td ><font size="2" face="Arial" color="#FFBD00">New GPM:</font>
		    </td>
