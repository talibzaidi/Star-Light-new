...
<%
' 11/8/15: Adjusted for HostMySite ("NEW server"), approximately a` la their article https://solutions.hostmysite.com/index.php?/Knowledgebase/Article/View/8596/0/using-cdosys-to-create-an-asp-mail-form-that-uses-smtp-authentication
' See working example in my file /MyTests/EmailOnNewServer/send_form_email.asp   
...
'password     = "K3ez6N2h"                   'No: Password for the above email address
'password     = bd4djuXx                     'No: Password for the above email address
'password      = "S6a2n2I6"                  'Yes 11/10/15: Password for the above email address
' [BN, 3/6/18] I changed password to the following (here and also in file EmailSend.asp in folders SCART and AskStarlite) ...
'password      = "S6a2n2I7"      
' [BN, 6/28/20] I changed password to the following (here and also in file EmailSend.asp in folders SCART and AskStarlite) ...
'password     = "!$2318Sz6No"             
'password      = "$621zBn7!"    'changed on Sept 7 2022
'password   = "x718Bnr#?_s"     'changed on Jan 26 2023
...
If TRUE Then
    ...
    Response.Write "<br>SubstitutedEmailSubject = " & SubstitutedEmailSubject
    Response.Write "<br>EmailReplyTo = "            & EmailReplyTo
    'Response.Write "<br>SubstitutedEmailBody = "   & SubstitutedEmailBody
End If
...
Set .Configuration = cdoConfig 
	...
	'.BCC		= EmailBCC
    .BCC        = "bn2@intelligineering.com"          ' Just during debugging.
