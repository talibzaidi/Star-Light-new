...
' [12/1/20, BN]  
' Google Search Console finds that the following URL causes a 5xx server error, apparently bc the item 010-00741-20 no longer exists in the db. 
' https://www.starlite-intl.com/scart/scart.asp?action=add&item=010-00741-20&count=1&sid=0&Area=&sar=Special
' That URL tries to add item/product 010-00741-20 to the Shopping Cart. The simplest way to avoid the 5xx error would be to modify my Sub AddItemToCart 
...
Sub AddItemToCart(iItemID, iItemCount)
    ...
    'Response.Write "<br>iItemID = " & iItemID  & " ... SCART.INC.SRS.ASP ... iItemCount = " & iItemCount 
        ...
        <tr>
			...
			<td valign="top" width="100">
				...
				<% If sar = "Manufa" OR sar = "New!" Then %>
						<td valign="top" width="250"><a HREF="https://www.starlite-intl.com/scart/scart.asp?action=add&amp;item=<%=aParameters(6)%>&amp;count=1&amp;sid=<%=aParameters(7)%>&amp;Area=&amp;sar="><img src="https://www.starlite-intl.com/images/order.gif" border="0" ></a><br>
				<% Else %>
				...
				<% End If %>
						  ...
						  <% ' [BN, 12/17/2017] Added this 3% test.
                            PercentagePriceDiff = abs((aParameters(3) - aParameters(4)) / aParameters(3)) * 100 
                                If PercentagePriceDiff > 3 Then 
                                    Response.Write "<font face='Tahoma' size='1'>Reg. Price </font> <font face='Tahoma' size='2'>" & aParameters(3) & "</font><br>"
                                End If
                          %>
