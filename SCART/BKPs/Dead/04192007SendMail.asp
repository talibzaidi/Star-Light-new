...
shpcrg = 0
	...
	' 4/17/07 BN: Begin creating body of email to Starlite ...
	strBODY = "<html><head></head><body>" 
	strBODY = strBODY & "<TABLE Border=1 CellPadding=3 CellSpacing=2 width=350>" 
	
	strBODY = strBODY & "<tr>" 
	strBODY = strBODY & "<TD colspan=5 bgcolor=#BBBBBB><font face=tahoma size=2><b>Sani is a Fink</b></font></TD>"
	strBODY = strBODY & "<td>&nbsp;</td>"
	strBODY = strBODY & "</tr>" 
	
	strBODY = strBODY & "<tr>" 
	strBODY = strBODY & "<TD colspan=1 bgcolor=#BBBBBB><font face=tahoma size=2><b>Name:</b></font></TD>"
	strBODY = strBODY & "<TD colspan=4 bgcolor=#DDDDDD><font face=tahoma size=2><b>" & Request("Name") & "</b></font></TD>"
	strBODY = strBODY & "<td>&nbsp;</td>"
	strBODY = strBODY & "</tr>" 
	
	strBODY = strBODY & "<tr>"	
	strBODY = strBODY & "<TD colspan=1 bgcolor=#BBBBBB><font face=tahoma size=2><b>Email:</b></font></TD>"
	strBODY = strBODY & "<TD colspan=4 bgcolor=#DDDDDD><font face=tahoma size=2><b>" + Request("Email") & "</b></font></TD>"
	strBODY = strBODY & "<td>&nbsp;</td>"
	strBODY = strBODY & "</tr>"
	
	strBODY = strBODY & "<tr><TD colspan=1 bgcolor=#BBBBBB><font face=tahoma size=2><b>Opt In to Emailings:</b></font></TD><TD colspan=4 bgcolor=#DDDDDD><font face=tahoma size=2><b>" + OptedIn
	strBODY = strBODY & "</b></font></TD><td>&nbsp;</td></tr><tr><TD colspan=1 bgcolor=#BBBBBB><font face=tahoma size=2><b>Phone:</b></font></TD><TD colspan=4 bgcolor=#DDDDDD><font face=tahoma size=2><b>" + Request("Phone")
	strBODY = strBODY & "</b></font></TD><td>&nbsp;</td></tr><tr><TD colspan=1 bgcolor=#BBBBBB><font face=tahoma size=2><b>Address:</b></font></TD><TD colspan=4 bgcolor=#DDDDDD><font face=tahoma size=2><b>" + Request("Address")
	strBODY = strBODY & "</b></font></TD><td>&nbsp;</td></tr><tr><TD colspan=1 bgcolor=#BBBBBB><font face=tahoma size=2><b>City:</b></font></TD><TD colspan=4 bgcolor=#DDDDDD><font face=tahoma size=2><b>" + Request("City")
	strBODY = strBODY & "</b></font></TD><td>&nbsp;</td></tr><tr><TD colspan=1 bgcolor=#BBBBBB><font face=tahoma size=2><b>State/Province:</b></font></TD><TD colspan=4 bgcolor=#DDDDDD><font face=tahoma size=2><b>" + Request("StateProv")
	strBODY = strBODY & "</b></font></TD><td>&nbsp;</td></tr><tr><TD colspan=1 bgcolor=#BBBBBB><font face=tahoma size=2><b>Postal Code:</b></font></TD><TD colspan=4 bgcolor=#DDDDDD><font face=tahoma size=2><b>" + Request("Postal")
	strBODY = strBODY & "</b></font></TD><td>&nbsp;</td></tr><tr><TD colspan=1 bgcolor=#BBBBBB><font face=tahoma size=2><b>Country:</b></font></TD><TD colspan=4 bgcolor=#DDDDDD><font face=tahoma size=2><b>" + Request("Country")
	strBODY = strBODY & "</b></font></TD><td>&nbsp;</td></tr><tr><TD colspan=1 bgcolor=#BBBBBB><font face=tahoma size=2><b>Payment Method:</b></font></TD><TD colspan=4 bgcolor=#DDDDDD><font face=tahoma size=2><b>" + Request("Payment")
	strBODY = strBODY & "</b></font></TD><td>&nbsp;</td></tr><tr><TD colspan=1 bgcolor=#BBBBBB><font face=tahoma size=2><b>Tax 1:</b></font></TD><TD colspan=4 bgcolor=#DDDDDD><font face=tahoma size=2><b>" + Request("Taxx1")
	strBODY = strBODY & "%</b></font></TD><td>&nbsp;</td></tr><tr><TD colspan=1 bgcolor=#BBBBBB><font face=tahoma size=2><b>Tax 2:</b></font></TD><TD colspan=4 bgcolor=#DDDDDD><font face=tahoma size=2><b>"+ Request("Taxx2")
	strBODY = strBODY & "%</b></font><br><br></TD><td>&nbsp;</td></tr><tr><TD bgcolor=#BBBBBB><font face=tahoma size=2><b>ID #</b></font></TD><TD bgcolor=#BBBBBB><font face=tahoma size=2><b>Description</b></font></TD><TD bgcolor=#BBBBBB><font face=tahoma size=2><b>Qty.</b></font></TD><TD bgcolor=#BBBBBB><font face=tahoma size=2><b>Price</b></font></TD><TD bgcolor=#BBBBBB><font face=tahoma size=2><b>Totals</b></font></TD><TD bgcolor=#BBBBBB><font face=tahoma size=2><b>Weight</b></font></TD></tr>"
	'44*************************
	...
	If Request("BigShip") = "on" then
		...
		'If weightTotal = 0 Then fTotal = 0.75   ' [BN] Not worth the trouble to distinguish between U.S. and Canada excgange rate.
	Else
