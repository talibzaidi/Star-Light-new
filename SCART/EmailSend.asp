...
If TRUE Then	
    ...
    'password =  "T6c#_S?By!zP"                    'changed Mar. 14, 2023
     password = "BgW%@f7Af_"			 'changed Aug. 23, 2023
...
If FALSE Then    ' 4/29/10: Tech support said CDONTS was unreliable, so I FALSE-d this out and started using ASPemail below.
    ...
    customerMail.BCC		= "sales@starlite-intl.com"   		' "sales@starlite-intl.com", 
...
If TRUE Then
    ...
    ObjSendMail.Bcc         = "starlite@starlite-intl.com"        ' So only starlite  a BCC copy of the invoice for Customer.
    ObjSendMail.Subject     = email_subject
    ObjSendMail.HTMLBody    = email_message
