...
<HEAD>
    ...
    <title>OEM GPS Sensors for Commercial and Fleet Companies | Star Lite International LLC</title>
    <meta NAME="Description" CONTENT="Star Lite International is the premier company for commercial and fleet OEM GPS sensors. We've been Serving Business, Government, OEM, Education and the General Public since 1994. Click for more info!">
    <meta NAME="Keywords" CONTENT="GPS modules,GPS sensors,OEM GPS,GPS navigation,OEM sensors,Garmin OEM GPS,USglobalsat OEM GPS,car GPS,handheld GPS,motorcycle GPS,GPS systems,Marine GPS,GPS accessories,GPS antennas">
</HEAD>
...
<tr>
	...
	<!-- #INCLUDE file="searchsummaryOEM-GPS-sensors.inc.asp"    
      ...
      SID = "173" 	' GPS Modules / OEM Sensors / Lidar
	-->
