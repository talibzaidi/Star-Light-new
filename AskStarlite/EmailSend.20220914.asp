...
' [12/6/20, BN:] Just an experiment, to see if I can use the Contact Us page to email myself (and Sani) the user's HTTP_USER_AGENT string. 
...
If TRUE Then	
    ...
    ' [BN, 3/6/18] I changed password to the following (here and also in files SCART/EmailSend.asp and Admin2/Emailing/EmailMergeINC.asp) ...
    ...
    If err.number <> 0 Then
        ...
        Response.write("<center><font color='blue' size='+1'><br><br><br><br>Unfortunately, the message could not be sent at this time. Please try again later.</font></center>")
    ...
    Else
        ...
        Response.write("<center><font color='blue' size='+1'><br><br><br><br>Thank you for contacting us. We will be in touch with you as soon as possible.</font></center>")
    End If
