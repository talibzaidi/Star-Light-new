...
<head>
	...
	<title>GPS sensors | GPS engine boards | OemGPS | tracking GPS | night vision | two-way communication | starlite-intl.com</title>
	<meta name="keywords" content="gps sensors,gps engine board,oem gps,gps navigation,garmin,usglobalsat,pharos,nuvi,gps tracking,smartphone,pda,gmrs,cb radio,2-way radio,scanner,camera,government contract,educational,military,veteran,ccr,gsa schedule,tools" />
