...
<head>
	...
	<title>GPS sensors | Oem GPS | GPS Engine Board | tracking GPS | NightVision Optics | communications</title>
	<meta name="keywords" content="gps sensors,gps engine board,oem gps,nuvi,edge,zumo,rino,garmin,usglobalsat,pharos,gps tracking,smartphone,pda,gmrs,Night Vision Goggles,Night Vision Scopes,Binoculars,Riflescopes,dosimeters,cb radio,2-way radio,scanner,government contracts,educational,military,gsa schedule,tools">
	<meta name="description" content="GPS sensors, GPS boards, OEM GPS, GPS engine, GPS engine Boards, GPS tracking, marine electronics, GPS Smartphones, 2-way radios, CB radios, scanners, accessories, night vision scopes, Binoculars, goggles, rifle scops">
