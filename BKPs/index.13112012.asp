...
<head>
	...
	<title>GPS sensors | GPS engine boards | OemGPS | tracking GPS | night vision | Electronics | Garmin | USglobalSat | Pharos</title>
	<meta name="keywords" content="gps,gps sensors,gps engine board,oem gps,gps navigation,garmin,usglobalsat,pharos,nuvi,gps tracking,smartphone,avl,pda,gmrs,cb radio,2-way radio,scanner,camera,government contract,educational,military,veteran,ccr,gsa schedule,tools" />
	<meta name="description" content="GPS at Star Lite Intl. The GPS source for GPS sensors, GPS boards, OEM GPS, GPS engine, GPS engine Boards, GPS tracking and Smartphones. Garmin GPS, USGlobalSat GPS, Pharos GPS, 2-way radios, CB radios, scanners, antennas and accessories. Digital cameras, night vision and audio/video equipment, tools." />
