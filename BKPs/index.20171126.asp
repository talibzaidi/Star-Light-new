...
<head>
	...
	<meta name="keywords" content="Garmin, USGlobalSat, GPS sensors, GPS boards, GPS engine, GPS, GPS engine boards, OEM GPS sensors, Lidar-Lite, Lidar-Lite V3, LIDAR-Lite V3 Laser Rangefinder, GPS engine boards, GPS tracking, GPS antennas, Uniden, Cobra, Midland, CB, amateur and marine radios, radio scanners, fish finders">
	...
	<meta name="abstract" content="Complete selection of Garmin and USGlobalSat GPS, GPS sensors, oem GPS, GPS engine boards, GPS modules, GPS antennas and accessories, Lidar-Lite V3, LIDAR-Lite Laser Rangefinder, marine electronics, sailing electronics, night vision optics, wide selection of cb radios, radio scanners, antennas and automotive electronics.">
                ...
                <td background="" valign="top">
					...
					<tr>
						...
						<% rhs.close %>
															...
															<% ' Start Table 1.1.5.2 %>
							<table border="1" cellpadding="3" cellspacing="0" width="95%" bordercolor="#000000">
							<tr>
								<td align="center">
								<a href="#top">
