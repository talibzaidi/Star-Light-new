...
Do While NOT rsOrders.EOF
	...
	If OrderDate <> "" Then
		OrderDate = FormatDateTime(rsOrders("OrderDate"), 2)   ' Just date part.
	End If
	...
	If PaymentMethod = "American Express" Then
		PaymentMethod = "Amex"
	ElseIf PaymentMethod = "Master Card" Then
		PaymentMethod = "MC"
	End If
	...
	If row Mod 20 = 1 Then
		Response.Write "<table align=center border=0 wwidth='100%' >"
		Response.Write "<tr bgcolor=lightblue><td></td><td></td><td align=center>i</td><td>OrderID</td><td>OrderDate</td><td>FName</td><td>LName</td>" & _
	...
	Response.Write "<td valign=top align=center>" & row & "</td>"
	...
	If row Mod 20 = 0 Then
		Response.Write "</table>"
	End If
	Response.Flush   				' Print the data now.
