...
10/23/15: On the "NEW server" at HostMySite, this file apparently needs to be updated a` la my file
/MyTests/EmailOnNewServer/send_form_email.asp
-->
...
If Database = "OptedInMailingList.mdb" Then
    ...
    Response.Write "<td align=center><b>Row</b></td> <td align=center><b>Email</b></td>  " & _
...
ElseIf Database = "PurchasedMailingList1.mdb" Then
    ...
    Response.Write "<table align=center cellpadding=3 border=0>"
    Response.Write "<tr bgcolor='lightblue'>"    
    Response.Write "<td><b>Row</b></td> <td align=center><b>Record ID</b></td> <td align=center><b>State</b></td>" & _
