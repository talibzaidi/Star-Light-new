...
<%
	...
	For row = 1 to TotalNumMembers ' NumRows 
		...
		Response.Write "<td valign='middle' align='left' width='100'  width='200'>"
        ...
        If CBool(Deleted) Then
            Response.Write "<td valign='top' align='center' style='vertical-align: middle;' width='100' width='120'>" 
