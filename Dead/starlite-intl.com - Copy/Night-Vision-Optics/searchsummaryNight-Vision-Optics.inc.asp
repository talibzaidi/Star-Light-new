...
'AID = "53"			' Category: Industrial, Night Vision, Personal and Home Electronics
'SID = "297"		' Subcategory: Night Vision Optics
%>
...
Sub XXXInitializeForKeywordSearch(Keyword0, Keyword)  
...
<%
ComingFrom = "CSCS"  ' Request.QueryString("CF")
...
' or InitializeForCatSubCatSearch again.	
	...
	Case "CSCS"
		...
		AID 		= "53"   'Request.QueryString("AID")			' i.e. ID of Product Area or Category.
		SID 		= "297"  'Request.QueryString("SID")			' i.e. ID of Product SubArea or SubCategory.
...
<%
	...
	For row = 1 to TotalNumMembers ' NumRows 
		...
		Response.Write "<td valign='middle' align='left' width='200'>"
            Response.Write "<a href='https://www.starlite-intl.com/Detail.asp?pid=" & PID & "'><img hspace='20' align='left' border='0' title='" & ProductName & "' alt='" & ProductName & "' src='" & graphicFile & "'></a>"                      
