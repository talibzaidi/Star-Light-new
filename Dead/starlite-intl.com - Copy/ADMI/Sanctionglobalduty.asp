...
If Action = "SUBMIT" Then
  ...
  RS.Open  "Select ITEMID, Duty from Product WHERE SID=" & Request("SID") , "DSN=STAREC1" , 1, 4
	...
	strSQL = "SELECT Duty, ITEMID FROM PRODUCT " & _
	 "WHERE ITEMID =" & RS("ITEMID")
	Set rst = Server.CreateObject("ADODB.Recordset")
	rst.Open strSQL, conn, adOpenStatic, _
 	adLockOptimistic, adCmdText 

                rst("Duty") = (rst("Duty")*Request("Prix"))
	...
	loop
       ...
       Response.Redirect "Sanctionglobalduty.asp"
...
elseIf Action = "CHANGE" Then
	 set RUS = CreateObject("ADODB.Recordset")
	 set RS = CreateObject("ADODB.Recordset")
  RS.Open  "Select ITEMID, Duty from Product WHERE SID=" & Request("SSID") , "DSN=STAREC1" , 1, 4
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
    ...
    <tr>
        ...
        <td><font color="#FFBD00" size="2" face="Arial">Multiply existing duties. OR Set your global duty change in decimal form. [ 0.5 = 50% ]</u> Choose by Sub-Area. </font></td>
    </tr>
    <tr>
        <td><font face="Arial"><img
...
<FORM ACTION="sanctionglobalduty.asp" METHOD="POST">
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
    ...
    <tr>
		...
		<tr>
                    <td ><font size="2" face="Arial" color="#FFBD00">Duty Multiplier:</font>
		    </td>
...
%>
			...
			RS.Close %>
               	...
               	<tr>
                    <td ><font size="2" face="Arial" color="#FFBD00">New Duty:</font>
		    </td>
