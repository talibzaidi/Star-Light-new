...
If Action <> "SubmitNewProduct" Then
	PID_SID	= Request.QueryString("PID_SID")	' Returned by FORM2 in querystring.
...
ElseIf Action = "SubmitNewProduct" Then
	SID	= Request("SID")						' Returned by FORM2, but not in querystring.
End If
...
Elseif  Action = "DeleteThisProduct" Then
	...
	Response.Redirect "sanction.asp?Action=EditOldProduct"		' Remember: the product just deleted is no longer in db. So cannot here go back to display it.
...
<tr>
	...
	-->
	<% If (Action = "DisplayProductToEdit") OR (Action = "DisplayProductToDelete") Then  ' In this case, PID and SID are known at this point.  %>
