...
<table border="0" cellpadding="5" cellspacing="0" width="100%">
    ...
    <tr> 
        ...
        <td>
        <a href="SanctionProductEdit.asp">
        <font color="#FFBD00" face="Arial" size="2" color="#FFBD00">Insert / Edit</font>
        </a>
        </td>
        <!--
        <td>
        ...
        <td>
        <a href="SanctionProductEdit.asp">
        <font color="#FFBD00" face="Arial" size="2" color="#FFBD00">Delete</font>
        </a>
        </td>
        -->
        <td>
        <a href="/Admin2/Products.asp">
        <font color="#FFBD00" face="Arial" size="2" color="#FFBD00">Display</font>
        </a>
        </td>
        </tr>
