...
' 11/12/16: The following case is for SUBMIT-ting and edited version of a pre-existing product / record (unlike the next case below). 
...
<tr>
	...
	<tr>
			...
			<FORM Name="form1" ACTION="http://www.starlite-intl.com/Admi/SanctionProductEdit.asp" METHOD="GET" > 
	...
	<FORM Name="form2" ACTION="SanctionProductEdit.asp?PID=<%=PID%>" METHOD=POST>
	<tr>
	...
	<tr>
		...
		<td width="100"><input type="text" size="30" name="PName" value="<%=RVS("PName")%>"></td>
		<td></td>
	</tr>
	...
	<tr>
		...
		%>
			...
			<select name="SID" size="1" >
				<!-- <option value="<%=RQVS("SID")%><%=RQVS("Subname")%>"</option> -->
				<option value="<%=RS("SID")%>"</option>
				<% Do While Not RS.EOF 
						If CStr(RS("SID")) = CStr(SID) Then 
				%>
							<option value="<%=RS("SID")%>" selected="selected" > <%=RS("SID")%>&nbsp;&nbsp;<%=RS("Subname")%> </option>
				<%		Else %>
							<option value="<%=RS("SID")%>" > <%=RS("SID")%>&nbsp;&nbsp;<%=RS("Subname")%> </option>
				<%		End If 
				   RS.MoveNext
				   Loop
				   RS.Close %>
	...
	<tr>
	    ...
	    <td width="100"><input type="text" size="30" name="ITEMID" value="<%=RVS("ITEMID")%>"></td>
        <td ></td>
	</tr>

	<tr>
	    <td align=right><font size="2" face="Arial" color="#FFBD00">UPC Code:</font></td>
	    <td width="100"><input type="text" size="30" name="UPC" value="<%=RVS("UPC")%>"></td>
        <td ></td>
	</tr>

	<tr>
	    <td align=right><font size="2" face="Arial" color="#FFBD00">Serial #:</font></td>
	    <td width="100"><input type="text" size="30" name="SerialNumber" value="<%=RVS("SerialNumber")%>"></td>
        <td ></td>
	</tr>

	<tr>
	    <td align=right><font size="2" face="Arial" color="#FFBD00">Description (250):</font></td>
	    <!-- <td width="100"><input type="text" size="180" name="Descr" value="<%=RVS("Descr")%>"></td> -->
		<td width="100"><textarea cols="110" name="Descr" rows="3"><%=RVS("Descr")%></textarea></td>
        <td ></td>
	</tr>
	...
	<tr>
		...
		<td width="100"><textarea cols="110" rows="10" name="Text1"><%=RVS("Text1")%></textarea></td>                                                  
	...
	<tr>
		...
		<td width="100"><textarea cols="110" rows="10" name="Text2"><%=RVS("Text2")%></textarea></td>
		<td></td>
	</tr>

	<tr>
		<td align=right><font size="2" face="Arial" color="#FFBD00">Thumbnail (250):</font></td>
		<td width="100"><font size="2" face="Arial"></font><input type="text" size="30" name="Pic1" value="<%=RVS("Pic1")%>"></td>
		<td ></td>
	</tr>

	<tr>
		<td align=right><font size="2" face="Arial" color="#FFBD00">Image (250):</font></td>
		<td width="100"><font size="2" face="Arial"></font><input type="text" size="30" name="Pic2" value="<%=RVS("Pic2")%>"></td>
		<td ></td>
	</tr>

	<tr>
		<td align=right><font size="2" face="Arial" color="#FFBD00">Manufacturers Name (250):</font></td>
		<td width="100"><font size="2" face="Arial"></font><input type="text" size="30" name="Manufa" value="<%=RVS("Manufa")%>"></td>
		<td ></td>
	</tr>

	<tr>
		<td align=right><font size="2" face="Arial" color="#FFBD00">Manufacturers Link (250):</font></td>
		<td width="100"><font size="2" face="Arial"></font><input type="text" size="30" name="ManURL" value="<%=RVS("ManURL")%>"></td>
		<td ></td>
	</tr>
	...
	<tr>
	    ...
	    <td width="100">
			...
			<tr>
				<td>
				<input type="text" size="30" name="Cost" value="<%=RVS("Cost")%>">
				</td>
				<td align='right'>
				<font size="2" face="Arial" color="#FFBD00">&nbsp;&nbsp;&nbsp;Vendors:</font>
				</td>
				<td>
				<input type="text" size="99" maxlength=250 name="Vendors" value="<%=RVS("Vendors")%>">
				</td>
			</tr>
			</table>
		</td>
	...
	<tr>
		...
		<td width="100"><input type="text" size="30" name="MSL" value="<%=RVS("MSL")%>"></td>
		<td ></td>
	</tr>

	<tr>
		<td align=right><font size="2" face="Arial" color="#FFBD00">GPM:</font></td>
		<td width="100"><input type="text" size="30" name="GPM" value="<%=RVS("GPM")%>"></td>
		<td ></td>
	</tr>

	<tr>
		<td align=right><font size="2" face="Arial" color="#FFBD00">Duty:</font></td>
		<td width="100"><input type="text" size="30" name="Duty" value="<%=RVS("Duty")%>"></td>
		<td ></td>
	</tr>
	
	<tr>
		<td align=right><font size="2" face="Arial" color="#FFBD00">Gross Weight:</font></td>
		<td width="100"><input type="text" size="30" name="Weight" value="<%=RVS("Weight")%>"></td>
		<td ></td>
	</tr>
	...
	<tr>  <!-- [BN, 12/15/11] Added this row.  -->
		...
		<td width="100"><textarea cols="110" name="RebateDescr" rows="3"><%=RVS("RebateDescr")%></textarea></td>
		<td></td>
	</tr>
	...
	<tr>
	<%  RVS.Close %>
		<td align=center bgcolor=bbbbbb colspan=3><INPUT type="submit"  NAME="Action" VALUE="Submit" ></td>
	</tr>
