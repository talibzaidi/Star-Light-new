...
<table border="0" cellpadding="8" cellspacing="0" width="100%">
    <tr>
        <td bgcolor="#FFBD00"><font face="Arial">
        <img src="Simages/sanction.gif" width="330" height="82">
        </font>
        </td>
        <td align="right" bgcolor="#FFBD00"><font face="Arial">
        <a href="sanction.asp"><img src="Simages/homegif.GIF" width="84" height="82" border="0"></a></font>
        </td>
    </tr>
    ...
    <tr>
        ...
        Create, Edit or Delete an <b>Area</b> of the online catalogue.
    ...
    <tr>
		...
		<tr>
			<td width=170>
			<b><font size="2" face="Arial">Area Name:</font></b>
		    </td>
			<td >
			<%
		...
		<tr>
			<td width=170>
			<b><font size="2" face="Arial">Area ID (AID):</font></b>
		    </td>
			<td >
			<%=AIDChoosen%>
		    </td>
		...
		<tr>
			<td valign=top>
			<b><font size="2" face="Arial">Area Description:</font></b>
		    </td>
			<td >
		...
		<tr>
			...
			<td >
		    <input type="text" size="119" name="AreaName" value="<%=ChosenAreaName%>">
		    </td>
		    <td>
			&nbsp;
		    </td>
		...
		<tr>
			<td width=170>
			<b><font size="2" face="Arial">Area Name:</font></b>
			<br><b><font size="1" face="Arial">Spell correctly!</font></b>
		    </td>
			<td >
			<input type="text" size="119" name="AreaName">
		    </td>
		    <td>
		    <% If ToDo = "CreateArea" Then %>
