...
Sub InitializeForCatSubCatSearch(CategoryID, SubCategoryID)
	...
	If TRUE Then 	' This block is always valid, whether user selected a category or a subcategory.
        'Response.Write "<br>CategoryID = "	& CategoryID
    ...
    Response.Write "<br><br>Session('ProductCountSQL') = " & Session("ProductCountSQL") 
	Set Conn 	= Nothing
...
If ComingFrom <> "KeywordSearch" Then 
	...
	Set Conn 			= Server.CreateObject("ADODB.Connection") 
    Response.Write "<br><br>ProductSQL = " & ProductSQL 
    Response.Write "<br><br>ProductCountSQL = " & ProductCountSQL 
