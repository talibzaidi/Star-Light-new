...
Response.Write ('<input type="text" name="x_fp_sequence" value="' + sequence + '" style="width:300;"> x_fp_sequence\n' );
Response.Write("<br>")
Response.Write ('<input type="text" name="x_fp_timestamp" value="' + tstamp + '" style="width:300;"> x_fp_timestamp\n' );
Response.Write("<br>")
Response.Write ('<input type="text" name="x_fp_hash" value="' + fingerprint + '" style="width:300;"> x_fp_hash\n' );
Response.Write("<br>")
