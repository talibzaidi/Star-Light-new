...
<% 
If False Then   ' 5/2/07, BN: No longet needed. Replaced by the Validator1(theForm) javascript function in Scart.inc.
...
InvoiceForCustomerHeader =	"" & _
			...
			"<tr><td align=center colspan=5><b><font face=Tahoma>Please <a href='http://www.starlite-intl.com'>Visit Us</a> Again<br><br></font></b></td></tr>" 
...
If request.form("Payment") = "Pay Pal" AND NOT ((ReQuest("Country") = "Canada") OR (ReQuest("Country") = "USA")) Then	
	ReplacementText = "Please note that for our international customers, " & _
					"shipping, insurance and handling costs will be higher than shown below. " & _
					"We will notify you by email regarding the additional costs. " & _
					"If you decline the additional costs, your order will be cancelled and your money fully refunded."
...
ElseIf request.form("Payment") <> "Pay Pal" AND NOT ((ReQuest("Country") = "Canada") OR (ReQuest("Country") = "USA")) Then	
	ReplacementText = 	"Please note that all our international customers must pay by <b>wire transfer</b>. " &_
					"Also, shipping, insurance and handling costs will be higher than shown below. " & _
...
OrderSQL = OrderSQL & " VALUES(#" & OrderDate & "# ,'" & OrderNum & "' ,'" & _
	ReQuest("FName") & "' ,'" & ReQuest("LName") & "' ,'" & ReQuest("Email") & "' ," & OptedIn2 & " ," & WeEmail & " ,'" & _
	ReQuest("Phone") & "' ,'" & ReQuest("Address") & "' ,'" & ReQuest("City") & "' ,'" & _
	ReQuest("StateProv") & "' ," & BigShipment & " ,'" & ReQuest("Postal") & "' ,'" & ReQuest("Country") & "', '" & _
	ReQuest("Payment") & "', " & ReQuest("Taxx1") & ", " & ReQuest("Taxx2") & ", " & _
	FormatNumber(ssTotal,2) & ", " & FormatNumber(osizeTotal,2) & ", " & FormatNumber(fTotal,2) & ", " & _
	FormatNumber(taxtoten,2) & ", " & FormatNumber(grndTotal,2) & ", " & FormatNumber(weightTotal ,2) & " );"
	
Response.Write "<br>OrderSQL = " & OrderSQL
'Response.End
