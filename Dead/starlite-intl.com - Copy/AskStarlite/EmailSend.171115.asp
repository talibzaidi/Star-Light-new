...
If TRUE Then	
    ...
    email_to =  "bn2@intelligineering.com"  ' "starlite@starlite-intl.com"    ' "bn2@intelligineering.com"   'Enter the email address you want to send to.
    ...
    reply_to = UserEmailAddress         '<-- doesn't work! "starlite@starlite-intl.com"     'Enter the email address you want recipient to reply to.
    ...
    email_message = "<strong>Customer's Name:</strong>&nbsp;"
    email_message = email_message & UserFullName & "<br /><br />"
    email_message = email_message & "<strong>Customer's Email:</strong>&nbsp;"
    email_message = email_message & UserEmailAddress & "<br /><br />"
    email_message = email_message & "<strong>Subject:</strong>&nbsp;"
    email_message = email_message & EmailSubject & "<br /><br />"
