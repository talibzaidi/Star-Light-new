...
<head>
	...
	<title>GPS sensors | Oem GPS | GPS Engine Board | tracking GPS | NightVisionOptics | communications</title>
	<meta name="keywords" content="gps sensors,gps engine board,oem gps,gpsmap,nuvi,garmin,usglobalsat,pharos,gps tracking,smartphone,pda,gmrs,Night Vision Goggles,Night Vision Scopes,Binoculars,Riflescopes,dosimeter,cb radio,2-way radio,scanner,dosimeters,government contract,educational,military,gsa schedule,tools" />
	<meta name="description" content="GPS sensors, GPS boards, OEM GPS, GPS engine, GPS engine Boards, GPS tracking, GPS Smartphones, 2-way radios, CB radios, scanners, accessories, night vision scopes, Binoculars, goggles, rifle scops /">
	<meta name="author" content="Star Lite International, LLC" />
	<meta name="copyright" content="1994-2013 Star Lite International, LLC" />
...
<table style="border:0px solid green;" width="200" align='center'>		<% ' Start Table 1 %>
<tr><td align="center">
...
<table border="0" width="100%" align="center" > <% ' Start Table 1.1 %>
            
            <tr>
			    <% If FALSE Then %>
                <td XXXclass="Gradient2" XXXwidth="223" valign="top" align="center">
					<table border=1 cellpadding="0">	<% ' Start of Table 1.1.4 %>
						<tr>
						<td>
							<center><XXXimg src="Images/StarLogo.png" XXXWIDTH="140" HEIGHT="140"></center>
                ...
                <td background="" valign="top" align="center">
					<table width="100%" border="0" cellpadding="0" cellspacing="0" align="center">  <% ' Start Table 1.1.5 %>
					<tr>
                        ...
                        <font size="2" face="Tahoma">
							<strong>&nbsp;&nbsp;&nbsp;</strong>
							<!-- #include virtual="mobile0/Index3.inc.asp"-->
						</font>
	...
	<!-- #include virtual="mobile0/Misc/Footer.INC" -->
