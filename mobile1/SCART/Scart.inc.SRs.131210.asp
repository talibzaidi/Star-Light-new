...
%>
	...
	<table border="0" CellPadding="5" CellSpacing="0" align="left">
		<tr bgcolor="#DDDDDD">
			...
			<td align=center><font face="tahoma" size="2"><b>Price /<br /><font color="red">Totals</font></b></font></td>
		</tr>
		...
		<tr>
			...
			<td  ALIGN="center" bgcolor="#EEEEEE" valign=middle>   <!-- [BN] Quantity field. -->
        		<input type="text" size="2" name="Qty" value="<%= dictCart(Key) %>">
				<br />
				<!-- <input type="image" src="http://www.starlite-intl.com/Images/button1.gif" name="Qtybut" value="Submit" border="0" WIDTH="50" HEIGHT="14"> -->
	<input type="image" src="http://www.starlite-intl.com/Images/button1.gif" name="Qtybut" value="Submit" border="0" WIDTH="40" HEIGHT="14">
