...
%>
	...
	For Each Key in dictCart    ' Loop over all products in shopping cart.
		NumItems = NumItems + 1
	Next	' End of For loop for counting number of products in the shopping cart.
	...
	%>
		...
		<table align="center" cellpadding="5" border="0">
			<tr>
				<td>
				<font  face="tahoma" style="font-size:large; color:navy">Your shopping cart is empty.</font>
				</td>
			</tr>
			<tr>
				<td align="center">
				<a href="https://www.starlite-intl.com/mobile1">
				<font face="tahoma" style="font-size:large; color:navy; text-decoration:underline;" ><u>Continue Shopping?</u></font>
				</a>
				</td>
			</tr>
		</table>
	...
	<table border="0" CellPadding="5" CellSpacing="0" align="left">
		<tr bgcolor="#DDDDDD">
			<td align=center width="100"><font face="tahoma" size="2"><b>Description<br /></b>/ ID #</font></td>
			<td align='center'><font face="tahoma" size="2"><b>Select<br />Qtty</b></font></td>
			<td align=center><font face="tahoma" size="2"><b>Price /</b><br /><font color="red"><b>Totals</b></font></font></td>
		</tr>
		...
		<tr>
			<td ALIGN="left" bgcolor="#EEEEEE">		<!-- [BN] Description field + ID # field. -->
				<b><font face="tahoma" size="2"><%= bParameters(1) %></font></b>
				<br />
				<font face="tahoma" size="2"><%= Key %></font>
			</td>       
            
			<form>
			<td  ALIGN="center" bgcolor="#EEEEEE" valign=middle>   <!-- [BN] Quantity field. -->
        		<input type="text" size="1" name="Qty" style="height: 25px; font-size: 20px;" value="&nbsp;&nbsp;<%= dictCart(Key) %>">
				<br />
				<!-- <input type="image" src="https://www.starlite-intl.com/Images/button1.gif" name="Qtybut" value="Submit" border="0" WIDTH="50" HEIGHT="14"> -->
				<input type="image" src="https://www.starlite-intl.com/Images/button1.gif" name="Qtybut" value="Submit" border="0" WIDTH="40" HEIGHT="14">
			...
			<td ALIGN="Right" bgcolor="#EEEEEE"> 		<!-- [BN] Price field + Total Price field. -->
				<font face="tahoma" size="2"><b><%= bParameters(4)%></b></font>

				<%	rowPrice = dictCart(Key) * CSng(bParameters(4)) 
					sTotal = sTotal + rowPrice 
				%>
				<br /><font face="tahoma" color="red" size="2"><b>$<%=FormatNumber(rowPrice, 2)%></b></font>
			</td>
			...
			<!-- <td bgcolor="#EEEEEE"> -->
				...
				If FALSE AND NOT IsNULL(rsThisProduct("HasAccessories")) AND Trim(rsThisProduct("HasAccessories")) <> "" Then
				%>
				<a href="../detail.asp?pid=<%=bParameters(5)%>#HasAccessories">
				<font face="tahoma" size="2">Accessory</font>
				</a>
				<br>
				<%
				End If
				...
				If FALSE AND Warranties <> "" AND NOT IsNull(Warranties) Then		' If this product (actually, if the subarea it belongs to) has one or more warranties
				%>
		...
		<tr>	
			<td COLSPAN="2" ALIGN="Right" bgcolor="white"><font face="tahoma" size="2"><b>Total:</b></font></td>
			<td ALIGN="Right" bgcolor="#EEEEEE"> 
		...
		<tr>
			<td colspan="3" ALIGN="Center" bgcolor="#DDDDDD">
				<font face="tahoma" size="2"><a href="https://www.starlite-intl.com/mobile1"><b>Continue Shopping?</b></a></font>
			</td>
		</tr>    
		...
		<tr>
			<td colspan="3">
				<center>
					...
					<br><big><span style="font-family: helvetica,arial,sans-serif;">Order online or by phone at: 1-800-387-8535</span></big>
					</font>
					<br><br>
	...
	<%
	End If     ' If NumItems = 0 Then ... ElseIf NumItems > 0 Then
	%>
    ...
    For I = 1 to iItemCount
        ...
        <tr>
			...
			<td valign="top" width="100">
				...
				<img SRC="<%= aParameters(0) %>" border="0" width="50" align="left"></a>
				<% 
...
Sub PlaceOrder()
    ...
    %>
        ...
        <% If aParameters(7) = TRUE Then osize = 8.75 End If %> 
