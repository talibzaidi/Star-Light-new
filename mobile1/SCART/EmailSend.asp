...
If TRUE Then	
   ...
   'host = "mail.starlite-intl.com"             'The mail server name. (Commonly mail.yourdomain.xyz if your mail is hosted with HostMySite).
    ...
    'password = "x718Bnr#?_s"
    'password = "S6a2n2I6"
    'password = "T6#_S?By!zP"                       'Password for the above email address.
     password = "T6c#_S?By!zP"			    'Changed Mar. 14 2023
    ' [BN, 3/7/18] I changed password to the following (here and in file AskStarlite/EmailSend.asp) ...
    'password = "S6a2n2I7"                       'Password for the above email address.    
    ' [BN, 6/25/20] I changed password to the following (here and also in file AskStarlite/EmailSend.asp) ...
    ...
    email_message = "Invoice for Star Lite (from <font color='#CC0000'>Mobile</font> site) ...<br /><br />"
    ...
    'ObjSendMail.HTMLBody    =  missing RHS!? 7/2/20. Replaced this line by following one.
...
' Copied from EmailSend.asp of non-mobile site on 11/12/17:
