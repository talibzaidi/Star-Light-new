...
Sub MakeTable2(Direction)
	...
	Response.Write "<table border='0' XXXwidth='100%'>"
...
<head>
	...
	<!-- The minimized style sheet is smaller and loads faster. foneFrame.css has comments and is readable. -->
	<link href="foneFrame-min.css" rel="stylesheet" type="text/css">
...
<table style="border:0px solid blue;" XXXwidth='1100'  bgcolor="" align='center'>		<% ' Start Table 1 %>
<tr><td>
