...
%>
	<table align="center" border="0" cellPadding="1" cellSpacing="1" width="95%">
		<tr>
			<td align="middle">
			<b><font size='5'><%=Session("SummaryHeading")%></font></b>
			<!-- 
	...
	For row = 1 to TotalNumMembers ' NumRows 
		...
		If RS("Manufa") <> "General Information" Then   ' Turn off the ORDER button if Manufacturer = "General Information" e.g. the "What is WAAS?" "product" 
			...
			%>
				...
				%>
					<br />
					<a href="http://starlite-intl.com/mobile1/detail.asp?pid=<%=PID%>#HasAccessories">
...
%>
	<table align="center" border="0" cellPadding="1" cellSpacing="1" width="95%">
		...
		<tr>
			<td align="middle">
			<font color='indigo' size=4><%=Session("SummaryHeading")%></font><br /><br />
			</td>
	</table>
<%
	...
	Do While NOT rsProduct.EOF 			
			...
			If CBool(Instr(ItemID0, Keyword0)) OR CBool(Instr(ProductName0, Keyword0)) OR CBool(Instr(Manufacturer0, Keyword0)) OR CBool(Instr(Description0, Keyword0)) Then    
                ...
                If CBool(Deleted) Then
                    Response.Write "<td valign='top' align='center' style='vertical-align: middle;' width='120'>" 
                    Response.Write "<font color='#B90000' size='2'>No Longer Available.</font><br>"
	                Response.Write "<a href=https://www.starlite-intl.com/mobile1/Detail.asp?pid=" & PID & "><font color='navy' size='1'>Click for possible alternatives and accessories</font></a></td>"
                Else
                    Response.Write "<td valign='top'></td>" 
                End If
				'Response.Write "<td valign='top'>$" & Cost & "</td>" 
