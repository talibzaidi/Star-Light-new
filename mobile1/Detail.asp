...
' [BN, 2/19/18] Added this block of variables (like I had in SearchSummary.inc2.asp on 2/18/18)...
...
'****************************************************
                ...
                End If
  				...
  				'Response.Write "</td>" 
   				...
   				Response.Write "</tr>"
				'Response.Write "<tr><td colspan='4'>" & USAPercentagePriceDiff & "</td></tr>"
                'Response.Write "<tr><td colspan='4'>" & CanadaPercentagePriceDiff & "</td></tr>"
...
' [BN, 2/20/18] Added this block of variables (like I had in SearchSummary.inc2.asp on 2/18/18)...
...
'****************************************************
			...
			If NumberOfParentsOfItemID = 1 Then
				Response.Write "<br><table style='border:0px solid #1800FF' align='center' width='100%'>"			
