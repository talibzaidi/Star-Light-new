...
<ul class="sf-menu" id="suckerfishnav">
	<li <%=HomeStyle%>><a href="https://www.starlite-intl.com"><font><small>Home</small></font></a></li>
	
	<!-- <li <%=ProductsStyle%>><a href="https://www.starlite-intl.com/search/search.asp"><small>Products</small></a></li> -->
	
	<% If TRUE OR Session("LoggedIn") = "Yes" Then %>
	<!-- 
	Suckerfish drop-down menu for Products ...
	#INCLUDE VIRTUAL = "/Misc/Navbars/navbar1b.inc2.asp"
	--> 
	<% End If %>

	<li <%=XXXHomeStyle%>><a href="https://www.starlite-intl.com/OEM-GPS-sensors/OEM-GPS-sensors.asp"><font><small>OEM GPS Sensors</small></font></a></li>

	<li <%=XXXHomeStyle%>><a href="https://www.starlite-intl.com/Night-Vision-Optics/Night-Vision-Optics.asp"><font><small>Night Vision Optics</small></font></a></li>
	
	<li <%=ContactUsStyle%>><a href="https://www.starlite-intl.com/Automotive-Fleet/Automotive-Fleet.asp"><small>Automotive Fleet GPS</small></a></li> 

	<li <%=SpecialsStyle%>><a><small>Specials</small></a>
	<ul>
		<li>&nbsp;</li>
	...
	<li <%=WhatsNewStyle%>><a><small>What's New?</small></a>
	<ul>
	...
	<!--
	<li <%=ContactUsStyle%>><a href="https://www.starlite-intl.com/Misc2/contact.asp">Contact Us</a></li>
	
	<li <%=TermsStyle%>><a href="https://www.starlite-intl.com/Misc2/Terms_and_Conditions.asp">Terms & Conditions</a></li>
	
	<li <%=LinksStyle%>><a href="https://www.starlite-intl.com/Misc2/LinkList.asp">Links</a></li>
	
	<li <%=GiftCertificatesStyle%>><a href="https://www.starlite-intl.com/aS/aS.asp">Amazon Outlet</a></li> 
    -->
	
	<li <%=ShoppingCartStyle%>><a href="https://www.starlite-intl.com/scart/scart.asp?action=viewcart&pid=0&sid=11&"><small>Cart</small> <img src="https://www.starlite-intl.com/images/SCRT.png" style="vertical-align:middle" /></a></li>
</ul>
